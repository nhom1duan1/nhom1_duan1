                ...
                <div class="container">
                    ...
                    <ul class="nav-top-right dagon-nav">
                        <li class="menu-item-has-children"><a href="#" class="dropdown-toggle"><img
                                    src="assets/images/general/vietnam.jpg" alt="flag">Việt Nam<i
                                    class="fa fa-angle-down" aria-hidden="true"></i></a>
                            <ul class="submenu parent-megamenu">
                                <li class="switcher-option">
                                    <a href="#" class="flag"><img src="assets/images/general/vietnam.jpg"
                                            alt="flag">Việt Nam</a>
                                </li>
                                <li class="switcher-option">
                                    <a href="#" class="flag"><img src="assets/images/general/l1.jpg"
                                            alt="flag">English</a>
                                </li>
                                <li class="switcher-option">
                                    <a href="#" class="flag"><img src="assets/images/general/l3.jpg"
                                            alt="flag">German</a>
                                </li>
                                <li class="switcher-option">
                                    <a href="#" class="flag"><img src="assets/images/general/l4.jpg"
                                            alt="flag">French</a>
                                </li>
                                <li class="switcher-option">
                                    <a href="#" class="flag"><img src="assets/images/general/l5.jpg"
                                            alt="flag">Canada</a>
                                </li>
                            </ul>
                        </li>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 col-sm-6 equal-elem">
                            <div class="links">
                                ...
                                <span class="span-newsletter">Đăng kí trở thành khách hàng thân thiết để nhận được thông
                                    tin về sản phẩm mới.</span>
