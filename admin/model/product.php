<?php 
	...
	function updateProduct($id,$cataid,$productName,$giaGoc,$giaGiam,$brand,$path,$truycap,$mota,$anhien,$thutu){
		if($path==""){
		$sql="update sanpham set ma_loai='$cataid', ten_sp='$productName',  gia_goc='$giaGoc', gia_giam='$giaGiam', ma_hang='$brand', hinh_anh='$path', truy_cap='$truycap', mo_ta='$mota', thu_tu='$thutu', an_hien='$anhien' where ma_sp='$id'";
		}else{
			$sql="update sanpham set ma_loai='$cataid', ten_sp='$productName',  gia_goc='$giaGoc', gia_giam='$giaGiam', ma_hang='$brand', truy_cap='$truycap', mo_ta='$mota', thu_tu='$thutu', an_hien='$anhien' where ma_sp='$id'";
